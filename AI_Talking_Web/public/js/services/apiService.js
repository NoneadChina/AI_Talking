...
class ApiService {
    constructor() {
        ...
        // 限流配置
        this.RATE_LIMIT = 5; // 每秒最多5个请求
        this.TOKEN_BUCKET_SIZE = 10; // 令牌桶大小
        this.tokens = this.TOKEN_BUCKET_SIZE;
    ...
    async sendChatMessage(request) {
        try {
            return await this.request(`${API_BASE_URL}/chat/send`, {
                method: 'POST',
                headers: {
     ...
     * 发送聊天消息（流式输出）
     */
    async sendChatMessageStream(request, onChunk, onComplete, onError) {
        try {
            const token = localStorage.getItem('token');
     ...
     * 开始讨论
     */
    async startDiscussion(request) {
        try {
            return await this.request(`${API_BASE_URL}/discussion/start`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    async startDebate(request) {
        try {
            return await this.request(`${API_BASE_URL}/debate/start`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    async getHistoryList() {
        try {
            const result = await this.request(`${API_BASE_URL}/history/list`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    async getHistoryDetail(index) {
        try {
            const result = await this.request(`${API_BASE_URL}/history/detail/${index}`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    async deleteHistory(index) {
        try {
            const result = await this.request(`${API_BASE_URL}/history/delete/${index}`, {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    async clearAllHistory() {
        try {
            const result = await this.request(`${API_BASE_URL}/history/clear`, {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json',
                },
     ...
     * 保存API设置
     */
    async saveSettings(apiConfig, systemPrompt) {
        try {
            const result = await this.request(`${API_BASE_URL}/settings/save`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    async loadSettings() {
        try {
            const result = await this.request(`${API_BASE_URL}/settings/load`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    async getAboutInfo() {
        try {
            const result = await this.request(`${API_BASE_URL}/about`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    async getErrorStatistics() {
        try {
            return await this.request(`${API_BASE_URL}/error-monitor/statistics`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    async getRecentErrors(count = 10) {
        try {
            return await this.request(`${API_BASE_URL}/error-monitor/recent-errors?count=${count}`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    async clearErrorRecords() {
        try {
            const result = await this.request(`${API_BASE_URL}/error-monitor/clear`, {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json',
                },
