...
class DebateService {
    ...
    private debateHistory: ChatMessageDisplay[] = [];
    ...
    async startDebate(
        ...
        try {
            ...
            const ai1FirstResponse = await this.aiService.getAIResponse(
                config.api1,
                config.model1,
                ai1Messages,
                config.temperature
            ...
            const ai1FirstMessage: ChatMessageDisplay = {
                sender: 'ai1',
    ...
    private checkTimeLimit(onStatusUpdate: (status: string) => void): boolean {
    ...
    getDebateHistory(): ChatMessageDisplay[] {
