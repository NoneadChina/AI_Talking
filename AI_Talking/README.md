...
- v1.1.0 (2026-01-07): 版本升级与功能优化
  - 修复历史功能中删除历史记录未真正保存的问题
  - 修复聊天功能中加载历史时的气泡嵌套问题
  - 修复历史功能中清空所有按钮缺少翻译键的问题
  - 修复Ollama API连接错误消息显示问题
  - 修复历史功能中导出全部功能的文件名格式问题
  - 优化聊天历史记录管理，确保聊天记录正确保存和更新
  - 改进聊天历史导入功能，解决气泡嵌套问题
  - 优化历史功能中导出选中功能，确保导出格式符合加载要求
